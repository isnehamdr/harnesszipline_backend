    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .card-enter { animation: fadeCard 0.55s cubic-bezier(.22,1,.36,1) both; }
        .success-enter { animation: scaleIn 0.5s cubic-bezier(.34,1.56,.64,1) both; }
        .spin { animation: spin 0.9s linear infinite; }
        .circle-anim { stroke-dasharray: 283; stroke-dashoffset: 283; animation: drawCircle 0.7s ease .15s forwards; }
        .check-anim  { stroke-dasharray: 60;  stroke-dashoffset: 60;  animation: drawCheck 0.45s ease .75s forwards; }
        ...
        .field-input:focus { border-bottom-color: #fe9a00; }
        .field-input::placeholder { color: #c0c0c0; }
        .field-input:disabled { opacity: .5; cursor: not-allowed; }
        .field-input.err { border-bottom-color: #fe9a00; }
        ...
        .btn-submit:hover:not(:disabled) {
          background: #e08800;
          transform: translateY(-1px);
          box-shadow: 0 6px 22px rgba(254,154,0,.4);
        }
        ...
        @media (max-width: 640px) {
          ...
          .right-panel { background: linear-gradient(150deg,#fe9a00 0%,#e07800 100%) !important; }
          .floating-card {
            left: 50% !important;
            width: 88% !important;
          }
      ...
      {/* ── Page shell ── */}
      <div style={{ fontFamily: "'DM Sans', sans-serif", minHeight: "100vh", position: "relative", overflow: "hidden", display: "flex" }}>

        {/* NAV */}
        <nav style={{ position: "fixed", top: 0, left: 0, right: 0, zIndex: 300, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "18px 28px" }}>
<img
  src="/images/logo.webp"
  alt="Logo"
  style={{
...
/>         
        ...
        <div className="left-panel" style={{
          width: "42%",
          minHeight: "100vh",
          background: "linear-gradient(150deg, #fe9a00 0%, #f08800 55%, #e07800 100%)",
          position: "relative",
          overflow: "hidden",
          display: "flex",
          ...
          {[220, 150, 88].map((s, i) => (
            <div key={i} style={{
              ...
              top: `${10 + i * 7}%`, right: -75 + i * 38,
              borderRadius: "50%",
              border: `1.5px solid rgba(255,255,255,${0.13 - i * 0.03})`,
            }} />
          ))}
          {/* wave */}
          <svg style={{ position: "absolute", bottom: 0, left: 0, width: "100%", height: 130 }} viewBox="0 0 420 130" preserveAspectRatio="none">
            <path d="M0 80 Q105 30 210 60 Q315 90 420 40 L420 130 L0 130Z" fill="rgba(0,0,0,0.09)" />
            <path d="M0 108 Q105 75 210 92 Q315 110 420 82 L420 130 L0 130Z" fill="rgba(0,0,0,0.07)" />
          </svg>
         
        </div>

        {/* RIGHT — white panel */}
        <div className="right-panel" style={{ flex: 1, minHeight: "100vh", background: "#f5f5f5", position: "relative", overflow: "hidden" }}>
          {/* rings */}
          {[260, 180, 100].map((s, i) => (
            <div key={i} style={{
              position: "absolute", width: s, height: s,
              right: -80 + i * 40, top: "50%", transform: "translateY(-50%)",
              borderRadius: "50%",
              border: `1.5px solid rgba(254,154,0,${0.13 - i * 0.03})`,
            }} />
          ))}
        </div>

        {/* CARD — floats over the split, absolutely centered */}
        <div className="floating-card card-enter" style={{
          position: "fixed",
          top: "50%",
          left: "50%",
          ...
          background: "#fff",
          borderRadius: 16,
          boxShadow: "0 8px 60px rgba(0,0,0,0.18), 0 2px 12px rgba(0,0,0,0.10)",
          padding: "44px 40px 36px",
          width: "100%",
          maxWidth: 400,
        }}>
          {status && (
            <div style={{ marginBottom: 16, padding: "10px 14px", background: "#f0faf0", borderRadius: 8, fontSize: 12, color: "#3a8a3a", textAlign: "center" }}>
              {status}
            </div>
          )}

          {loginSuccess ? (
            <div className="success-enter" style={{ textAlign: "center", padding: "20px 0" }}>
              <svg width="72" height="72" viewBox="0 0 100 100" style={{ margin: "0 auto 16px", display: "block" }}>
                <circle cx="50" cy="50" r="45" stroke="rgba(254,154,0,0.15)" strokeWidth="2" fill="none" />
                <circle cx="50" cy="50" r="45" stroke="#fe9a00" strokeWidth="2" fill="none" className="circle-anim" />
                <polyline points="28,50 43,65 72,34" stroke="#fe9a00" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round" className="check-anim" />
              </svg>
              <h3 style={{ fontFamily: "'Playfair Display', serif", fontSize: "1.7rem", color: "#222", marginBottom: 6 }}>Welcome!</h3>
              <p style={{ fontSize: 12, color: "#aaa", fontWeight: 300 }}>Redirecting you now…</p>
            </div>
          ) : (
            <>
              <p style={{ textAlign: "center", fontSize: 12, fontWeight: 500, letterSpacing: ".16em", textTransform: "uppercase", color: "#555", marginBottom: 8 }}>
                Sign Up
              </p>
              <div style={{ width: 24, height: 3, background: "#fe9a00", borderRadius: 2, margin: "0 auto 28px" }} />

              <form onSubmit={submit}>
                {/* Name */}
                {/* <div style={{ position: "relative", marginBottom: 22 }}>
                  <input type="text" placeholder="Name" className="field-input" disabled={processing} style={{ paddingRight: 30 }} />
                  <span style={{ position: "absolute", right: 0, top: "50%", transform: "translateY(-50%)", color: "#d0d0d0", pointerEvents: "none", display: "flex" }}>
                ...
                <div style={{ position: "relative", marginBottom: 22 }}>
                  <input
                    ...
                    placeholder="Email" autoComplete="username" disabled={processing}
                  ...
                  {errors.email && <p style={{ color: "#fe9a00", fontSize: 11, marginTop: 3 }}>{errors.email}</p>}
                </div>
                ...
                <div style={{ position: "relative", marginBottom: 28 }}>
                  <input
                    ...
                    placeholder="Password" autoComplete="current-password" disabled={processing}
                    className={`field-input${errors.password ? " err" : ""}`}
                    style={{ paddingRight: 30 }}
                  />
                  <button type="button" onClick={() => setShowPassword(p => !p)} disabled={processing}
                    style={{ position: "absolute", right: 0, top: "50%", transform: "translateY(-50%)", background: "none", border: "none", cursor: "pointer", padding: 0, color: "#d0d0d0", display: "flex" }}>
                    {showPassword
                  ...
                  {errors.password && <p style={{ color: "#fe9a00", fontSize: 11, marginTop: 3 }}>{errors.password}</p>}
                </div>

                <button type="submit" className="btn-submit" disabled={processing}>
                  {processing
                    ? <><svg className="spin" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><circle cx="12" cy="12" r="10" strokeOpacity=".25"/><path d="M12 2a10 10 0 0 1 10 10"/></svg>Processing…</>
                    : "Login"
                  }
                </button>
