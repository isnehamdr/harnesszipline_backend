    ...
    <div style={{ fontFamily: "'Cormorant Garamond', serif" }} className="min-h-screen bg-[#0a0a0a] flex overflow-hidden">
      <style>{`
        ...
        * { box-sizing: border-box; }
        ...
        .animate-slide-in { animation: slide-in-right 0.6s ease forwards; }
      ...
      {/* Left Panel - Now with Background Image */}
      <div
        ref={panelRef}
      ...
      >
        ...
        {/* Dynamic gradient following mouse (now with adjusted opacity) */}
        <div
        ...
        <div className="animate-float-slow absolute top-[15%] right-[20%] w-64 h-64 rounded-full opacity-30"
          style={{ background: "radial-gradient(circle, rgba(201,169,110,0.5) 0%, transparent 70%)" }} />
        <div className="animate-float-medium absolute bottom-[20%] left-[10%] w-48 h-48 rounded-full opacity-20"
        ...
        {/* Content - with increased z-index to appear above overlay */}
        ...
        <div className="relative z-10 w-full max-w-[420px] px-8 py-12">
          ...
          {!loginSuccess && (
            <>
              ...
              {/* Form */}
              <form onSubmit={handleSubmit} className={`stagger ${isMounted ? "mounted delay-300" : ""} space-y-5`}>
                ...
                <div className="flex items-center justify-between pt-1">
                  <label className="flex items-center gap-2.5 cursor-pointer group">
                    <div className="relative">
                      ...
                      <div
                        ...
                        style={{
                          borderColor: rememberMe ? "rgba(201,169,110,0.7)" : "rgba(255,255,255,0.15)",
                          background: rememberMe ? "rgba(201,169,110,0.15)" : "transparent"
                        }}
                  ...
                  <a href="#" className="sans text-[rgba(201,169,110,0.6)] hover:text-[#c9a96e] text-xs font-light transition-colors border-b border-[rgba(201,169,110,0.2)] hover:border-[rgba(201,169,110,0.5)] pb-px">
                    Forgot password?
                  </a>
                </div>
                ...
                {/* Error */}
                {errors.form && (
                  <div className="p-3.5 border border-[rgba(220,60,60,0.2)] bg-[rgba(220,60,60,0.05)] rounded-sm">
                    <p className="sans text-[#e07070] text-xs font-light">{errors.form}</p>
                  </div>
                )}
