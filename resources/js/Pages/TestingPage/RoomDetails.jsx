...
const RoomDetails = ({ room: initialRoom }) => {
    ...
    const fetchRoomDetails = async () => {
        ...
        try {
            ...
            if (roomData.meta_data && !roomData.meta_data.seo) {
                roomData.meta_data = {
                    ...roomData.meta_data,
                    seo: generateDefaultSeo(roomData)
                };
            }
    ...
    const getSEOMetadata = () => {
        ...
        const defaultSEO = {
            ...
            description: room?.short_description || "Experience luxury and comfort in our thoughtfully designed room.",
            keywords: "hotel room, accommodation, luxury stay, hotel booking",
            ogImage: images[0]?.image ? getImageUrl(images[0].image) : "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?w=1200&q=80",
            ogType: "product",
    ...
    const generateStructuredData = () => {
        ...
        const images_list = images.map(img => getImageUrl(img.image)).filter(Boolean);
        ...
        return {
            ...
            "image": images_list,
            "sku": room.refrence_id || room.id,
            "brand": {
                "@type": "Brand",
                "name": room.roomType?.name || "Hotel Room"
            },
            "offers": {
                "@type": "Offer",
                "price": room.price,
            ...
            "aggregateRating": room.meta_data?.seo?.aggregateRating || {
