...
//                                         className={`
//                                             flex items-center justify-center w-full p-3 rounded-lg transition-colors duration-200 group
//                                             ${isGroupActive(["/job-enquiry", "/job"]) ? "bg-blue-50 text-blue-700" : "text-gray-600 hover:bg-blue-50 hover:text-blue-700"}
//                                         `}
//                                     >
//                                         <ListFilter
//                                             className={iconClasses(
...
//                                                 className={`
//                                                     flex items-center px-3 py-2.5 text-sm transition-colors duration-200
//                                                     ${isActive("/job") ? "bg-blue-50 text-blue-700 font-medium" : "text-gray-600 hover:bg-blue-50 hover:text-blue-700"}
//                                                 `}
//                                             >
//                                                 <span className="whitespace-nowrap">
//                                                     Jobs
